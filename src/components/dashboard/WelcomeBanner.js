    ...
    return (
        <div className="bg-primary  py-2 px-4 rounded-lg flex justify-between items-center mb-6">
            <div className="flex items-center ">
                <h1 className="md:text-2xl text-xs whitespace-nowrap text-white font-bold">Welcome Aboard, {name} 👋</h1>
                <p className="ml-4 hidden md:block md:text-lg text-gray-300 font-bold">We&apos;re thrilled to have you join Techrity Team!</p>
            </div>
